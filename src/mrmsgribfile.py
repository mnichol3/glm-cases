...
class MRMSGribFile(object):
    ...
    def parse_scan_angle(self, fname):
        regex = re.compile(r'_(\d{2}.\d{2})_')
    ...
    def __repr__(self):
        return '<MRMSGribFile object - {}>'.format(self.validity_date + '-' + self.validity_time)
